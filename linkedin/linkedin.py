#!/usr/bin/env python3
"""
LinkedIn via RapidAPI (jobs-search-api) com output JSON e incremental simples.
"""
...
def normalize(row: dict) -> dict:
    return {
        ...
        "source": row.get("job_publisher") or row.get("site") or "linkedin_rapidapi",
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="RapidAPI jobs-search-api scraper (LinkedIn)")
    ...
    parser.add_argument("--site-name", type=str, default="linkedin", help="Lista separada por virgulas")
    parser.add_argument("--timeout", type=int, default=45)
    parser.add_argument("--retries", type=int, default=3)
    parser.add_argument(
        "--output-json",
        type=str,
        default="data/linkedin/professions.json",
    )
    ...
    payload = {
        ...
        "site_name": site_names or ["linkedin"],
