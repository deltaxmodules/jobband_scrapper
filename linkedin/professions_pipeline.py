#!/usr/bin/env python3
"""
Pipeline unico: adiciona `professions` em cada registo de vagas LinkedIn.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Adiciona professions em cada registo do JSON de vagas LinkedIn."
    )
    parser.add_argument(
        "--input",
        default="data/linkedin/professions.json",
        help="JSON de entrada (default: data/linkedin/professions.json).",
    )
    parser.add_argument(
        "--output",
        default="",
